...
describe('Limit Order Native', function() {
    ...
    it('should correct detect that order is from native asset', function() {
        var ethOrderFactory = new ProxyFactory(Address.fromBigInt(228n), Address.fromBigInt(2n));
        var maker = new Address('0x00000000219ab540356cbb839cbe05303d7705fa');
        var nativeOrder = LimitOrder.fromNative(1, ethOrderFactory, {
            takerAsset: new Address('0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'),
            makingAmount: 1000000000000000000n,
            takingAmount: 1420000000n,
            maker: maker,
        ...
        expect(LimitOrder.fromDataAndExtension(nativeOrder.build(), nativeOrder.extension).isNative(1, ethOrderFactory, nativeOrder.nativeSignature(maker))).toEqual(true);
    });
    ...
    it('should correct detect that order is NOT from native asset', function() {
        ...
        expect(LimitOrder.fromDataAndExtension(order.build(), order.extension).isNative(1, ethOrderFactory, order.nativeSignature(maker))).toEqual(false);
    });
});
